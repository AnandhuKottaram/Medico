												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.html"><?php echo $uname;?> </a>
														</h2>
													</td>
													<td><?php echo $add;?></td>
													<td><?php echo $ph;?></td>
													...
													<td><?php echo $gen;?></td>
													<?php 
													 $q=mysqli_query($con,"SELECT * FROM `bboking` WHERE uid='$uid';");
													 if($q){
													 $ans=mysqli_num_rows($q);
													 ?>
													<td class="text-center"> <span style="color:green; font-size:28px;"><?php echo $ans; ?></span></td>
													<?php
													 }
													 }
													}
