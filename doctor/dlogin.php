...
<head>
				...
				<nav class="navbar navbar-expand-lg header-nav">
					...
					<div class="main-menu-wrapper">
						...
						<ul class="main-nav">
							...
							<li class="login-link">
								<a href="plogin.html">Login / Signup</a>
							</li>
						</ul>		 
					</div>		 
								...
								<div class="row align-items-center justify-content-center">
									...
									<div class="col-md-12 col-lg-6 login-right">
										<div class="login-header">
											<h3>Doctor Login <a href="../patient/plogin.php">Are you Patient?</a></h3>
										</div>
										...
										<form action="" method="POST">
											...
											<div class="text-center dont-have">Don’t have an account? <a href="dregister.php">Register</a></div>
										</form>
									</div>
								</div>
							</div>
 ...
 if (isset($_POST['ubtn']))
	...
	$count=0;
	$sql=mysqli_query($con," SELECT * from `doc_reg` where demail='$_POST[demail]' && dpass='$_POST[dpass]';");
	...
	{ 
		$_SESSION['dname']=$count['dname'];
		$_SESSION['demail']=$count['demail'];
		$_SESSION['spec']=$count['spec'];
	   ...
	   ?>
	  <script>
		 location.replace("../doctor/ddash.php");
